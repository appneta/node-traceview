const logSend = require('debug')('traceview:event:send')
const logEnter = require('debug')('traceview:event:enter')
const logChange = require('debug')('traceview:event:change')
const logEdge = require('debug')('traceview:event:edge')
const logError = require('debug')('traceview:event:error')
const logSet = require('debug')('traceview:event:set')
...
function continueTrace (parent) {
  ...
  let ctx = addon.Context.toString()
  ...
  let e = addon.Context.createEvent()
